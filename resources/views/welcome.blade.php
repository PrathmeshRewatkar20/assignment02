<x-guest-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-blue-100 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
            <img src="" alt="Cover" class="mb-4 rounded-lg w-full h-64 object-contain">
            <h2 class="text-2xl font-bold mb-2 text-blue-500">New Title 1</h2>
            <p class="text-gray-700 mb-4">A captivating review of New with insightful analysis.</p>
        ...
        <div class="bg-green-100 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
            <img src="" alt="Cover" class="mb-4 rounded-lg w-full h-64 object-contain">
            <h2 class="text-2xl font-bold mb-2 text-green-500">New Title 2</h2>
            <p class="text-gray-700 mb-4">Explore the review of New and discover its literary merits.</p>
        ...
        <div class="bg-yellow-100 p-6 rounded-lg shadow-md transition-transform transform hover:scale-105">
            <img src="" alt="Cover" class="mb-4 rounded-lg w-full h-64 object-contain">
            <h2 class="text-2xl font-bold mb-2 text-yellow-500">New Title 3</h2>
            <p class="text-gray-700 mb-4">Dive into the world of New with this comprehensive book review.</p>
